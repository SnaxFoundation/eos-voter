    ...
    return (
      <Segment padding="true" basic>
        <Header textAlign="center">
          <p>{`${t('tools_form_create_account_confirming_header_one')} ${totalCost.toFixed(4)} ${connection.chainSymbol || 'SNAX'}.`}</p>
          <p>
            {`${t('tools_form_create_account_confirming_header_two')} ${totalDelegated.toFixed(4)} ${connection.chainSymbol || 'SNAX'} ${t('tools_form_create_account_confirming_header_three')}`}
          </p>
        </Header>
